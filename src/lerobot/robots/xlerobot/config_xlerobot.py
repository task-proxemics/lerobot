...
class XLerobotConfig(RobotConfig):
    ...
    port1: str = "/dev/ttyACM2"  # port to connect to the bus (left so101 + head camera)
    port2: str = "/dev/ttyACM1"  # port to connect to the bus (right so101 same as lekiwi setup)
